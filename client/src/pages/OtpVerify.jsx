...
function OtpVerify() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("https://naturenest-y4n0.onrender.com/api/user/verify-otp", {
        otp: otp.join(""),
  ...
  const handleResend = async () => {
    try {
      await axios.post("https://naturenest-y4n0.onrender.com/api/user/send-otp", {
        email: userData.email,
      });
